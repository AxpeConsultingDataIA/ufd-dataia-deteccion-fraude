...
metricas_eventos_grupo AS (
  SELECT
    ...
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_semana_actual,
  
    -- Semana pasada - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_semana_pasada,
    
    -- Misma semana año pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_semana_anio_pasado,

    -- Mes actual - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_mes_actual,

    -- -- Mes pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_mes_pasado,
    
    -- -- Mismo mes año pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_mes_anio_pasado,
    
    -- -- Trimestre actual - eventos grupo 4 por tipo    
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_trimestre_actual,
    
    -- -- Trimestre pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_trimestre_pasado,
    
    -- -- Mismo trimestre año pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_trimestre_anio_pasado,
    
    -- -- Año actual - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_anio_actual,
    
    -- -- Año pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 2 THEN 1 END) AS  eventos_grupo3_tipo2_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 3 THEN 1 END) AS  eventos_grupo3_tipo3_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 4 THEN 1 END) AS  eventos_grupo3_tipo4_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 6 THEN 1 END) AS  eventos_grupo3_tipo6_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 7 THEN 1 END) AS  eventos_grupo3_tipo7_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 8 THEN 1 END) AS  eventos_grupo3_tipo8_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 9 THEN 1 END) AS  eventos_grupo3_tipo9_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 10 THEN 1 END) AS eventos_grupo3_tipo10_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 11 THEN 1 END) AS eventos_grupo3_tipo11_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 12 THEN 1 END) AS eventos_grupo3_tipo12_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 14 THEN 1 END) AS eventos_grupo3_tipo14_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 15 THEN 1 END) AS eventos_grupo3_tipo15_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 16 THEN 1 END) AS eventos_grupo3_tipo16_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 17 THEN 1 END) AS eventos_grupo3_tipo17_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 18 THEN 1 END) AS eventos_grupo3_tipo18_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 19 THEN 1 END) AS eventos_grupo3_tipo19_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 20 THEN 1 END) AS eventos_grupo3_tipo20_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 21 THEN 1 END) AS eventos_grupo3_tipo21_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 22 THEN 1 END) AS eventos_grupo3_tipo22_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 23 THEN 1 END) AS eventos_grupo3_tipo23_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 3 AND s09.c = 24 THEN 1 END) AS eventos_grupo3_tipo24_anio_pasado,
...
--   CASE WHEN mc.consumo_max_anio_pasado > per_aco.percentil99_anio_pasado_aco THEN true ELSE false END AS pico_anomalo_general_anio_pasado_aco,
  ...
  -- Semana actual
meg.eventos_grupo3_tipo2_semana_actual,
meg.eventos_grupo3_tipo3_semana_actual,
meg.eventos_grupo3_tipo4_semana_actual,
meg.eventos_grupo3_tipo6_semana_actual,
meg.eventos_grupo3_tipo7_semana_actual,
meg.eventos_grupo3_tipo8_semana_actual,
meg.eventos_grupo3_tipo9_semana_actual,
meg.eventos_grupo3_tipo10_semana_actual,
meg.eventos_grupo3_tipo11_semana_actual,
meg.eventos_grupo3_tipo12_semana_actual,
meg.eventos_grupo3_tipo14_semana_actual,
meg.eventos_grupo3_tipo15_semana_actual,
meg.eventos_grupo3_tipo16_semana_actual,
meg.eventos_grupo3_tipo17_semana_actual,
meg.eventos_grupo3_tipo18_semana_actual,
meg.eventos_grupo3_tipo19_semana_actual,
meg.eventos_grupo3_tipo20_semana_actual,
meg.eventos_grupo3_tipo21_semana_actual,
meg.eventos_grupo3_tipo22_semana_actual,
meg.eventos_grupo3_tipo23_semana_actual,
meg.eventos_grupo3_tipo24_semana_actual,
  -- Semana pasada
meg.eventos_grupo3_tipo2_semana_pasada,
meg.eventos_grupo3_tipo3_semana_pasada,
meg.eventos_grupo3_tipo4_semana_pasada,
meg.eventos_grupo3_tipo6_semana_pasada,
meg.eventos_grupo3_tipo7_semana_pasada,
meg.eventos_grupo3_tipo8_semana_pasada,
meg.eventos_grupo3_tipo9_semana_pasada,
meg.eventos_grupo3_tipo10_semana_pasada,
meg.eventos_grupo3_tipo11_semana_pasada,
meg.eventos_grupo3_tipo12_semana_pasada,
meg.eventos_grupo3_tipo14_semana_pasada,
meg.eventos_grupo3_tipo15_semana_pasada,
meg.eventos_grupo3_tipo16_semana_pasada,
meg.eventos_grupo3_tipo17_semana_pasada,
meg.eventos_grupo3_tipo18_semana_pasada,
meg.eventos_grupo3_tipo19_semana_pasada,
meg.eventos_grupo3_tipo20_semana_pasada,
meg.eventos_grupo3_tipo21_semana_pasada,
meg.eventos_grupo3_tipo22_semana_pasada,
meg.eventos_grupo3_tipo23_semana_pasada,
meg.eventos_grupo3_tipo24_semana_pasada,

  -- Semana año pasado
meg.eventos_grupo3_tipo2_semana_anio_pasado,
meg.eventos_grupo3_tipo3_semana_anio_pasado,
meg.eventos_grupo3_tipo4_semana_anio_pasado,
meg.eventos_grupo3_tipo6_semana_anio_pasado,
meg.eventos_grupo3_tipo7_semana_anio_pasado,
meg.eventos_grupo3_tipo8_semana_anio_pasado,
meg.eventos_grupo3_tipo9_semana_anio_pasado,
meg.eventos_grupo3_tipo10_semana_anio_pasado,
meg.eventos_grupo3_tipo11_semana_anio_pasado,
meg.eventos_grupo3_tipo12_semana_anio_pasado,
meg.eventos_grupo3_tipo14_semana_anio_pasado,
meg.eventos_grupo3_tipo15_semana_anio_pasado,
meg.eventos_grupo3_tipo16_semana_anio_pasado,
meg.eventos_grupo3_tipo17_semana_anio_pasado,
meg.eventos_grupo3_tipo18_semana_anio_pasado,
meg.eventos_grupo3_tipo19_semana_anio_pasado,
meg.eventos_grupo3_tipo20_semana_anio_pasado,
meg.eventos_grupo3_tipo21_semana_anio_pasado,
meg.eventos_grupo3_tipo22_semana_anio_pasado,
meg.eventos_grupo3_tipo23_semana_anio_pasado,
meg.eventos_grupo3_tipo24_semana_anio_pasado,

  -- Mes actual
meg.eventos_grupo3_tipo2_mes_actual,
meg.eventos_grupo3_tipo3_mes_actual,
meg.eventos_grupo3_tipo4_mes_actual,
meg.eventos_grupo3_tipo6_mes_actual,
meg.eventos_grupo3_tipo7_mes_actual,
meg.eventos_grupo3_tipo8_mes_actual,
meg.eventos_grupo3_tipo9_mes_actual,
meg.eventos_grupo3_tipo10_mes_actual,
meg.eventos_grupo3_tipo11_mes_actual,
meg.eventos_grupo3_tipo12_mes_actual,
meg.eventos_grupo3_tipo14_mes_actual,
meg.eventos_grupo3_tipo15_mes_actual,
meg.eventos_grupo3_tipo16_mes_actual,
meg.eventos_grupo3_tipo17_mes_actual,
meg.eventos_grupo3_tipo18_mes_actual,
meg.eventos_grupo3_tipo19_mes_actual,
meg.eventos_grupo3_tipo20_mes_actual,
meg.eventos_grupo3_tipo21_mes_actual,
meg.eventos_grupo3_tipo22_mes_actual,
meg.eventos_grupo3_tipo23_mes_actual,
meg.eventos_grupo3_tipo24_mes_actual,

  -- Mes pasado
meg.eventos_grupo3_tipo2_mes_pasado,
meg.eventos_grupo3_tipo3_mes_pasado,
meg.eventos_grupo3_tipo4_mes_pasado,
meg.eventos_grupo3_tipo6_mes_pasado,
meg.eventos_grupo3_tipo7_mes_pasado,
meg.eventos_grupo3_tipo8_mes_pasado,
meg.eventos_grupo3_tipo9_mes_pasado,
meg.eventos_grupo3_tipo10_mes_pasado,
meg.eventos_grupo3_tipo11_mes_pasado,
meg.eventos_grupo3_tipo12_mes_pasado,
meg.eventos_grupo3_tipo14_mes_pasado,
meg.eventos_grupo3_tipo15_mes_pasado,
meg.eventos_grupo3_tipo16_mes_pasado,
meg.eventos_grupo3_tipo17_mes_pasado,
meg.eventos_grupo3_tipo18_mes_pasado,
meg.eventos_grupo3_tipo19_mes_pasado,
meg.eventos_grupo3_tipo20_mes_pasado,
meg.eventos_grupo3_tipo21_mes_pasado,
meg.eventos_grupo3_tipo22_mes_pasado,
meg.eventos_grupo3_tipo23_mes_pasado,
meg.eventos_grupo3_tipo24_mes_pasado,
--   
--   Mes año pasado
meg.eventos_grupo3_tipo2_mes_anio_pasado,
meg.eventos_grupo3_tipo3_mes_anio_pasado,
meg.eventos_grupo3_tipo4_mes_anio_pasado,
meg.eventos_grupo3_tipo6_mes_anio_pasado,
meg.eventos_grupo3_tipo7_mes_anio_pasado,
meg.eventos_grupo3_tipo8_mes_anio_pasado,
meg.eventos_grupo3_tipo9_mes_anio_pasado,
meg.eventos_grupo3_tipo10_mes_anio_pasado,
meg.eventos_grupo3_tipo11_mes_anio_pasado,
meg.eventos_grupo3_tipo12_mes_anio_pasado,
meg.eventos_grupo3_tipo14_mes_anio_pasado,
meg.eventos_grupo3_tipo15_mes_anio_pasado,
meg.eventos_grupo3_tipo16_mes_anio_pasado,
meg.eventos_grupo3_tipo17_mes_anio_pasado,
meg.eventos_grupo3_tipo18_mes_anio_pasado,
meg.eventos_grupo3_tipo19_mes_anio_pasado,
meg.eventos_grupo3_tipo20_mes_anio_pasado,
meg.eventos_grupo3_tipo21_mes_anio_pasado,
meg.eventos_grupo3_tipo22_mes_anio_pasado,
meg.eventos_grupo3_tipo23_mes_anio_pasado,
meg.eventos_grupo3_tipo24_mes_anio_pasado,

--   Trimestre actual
meg.eventos_grupo3_tipo2_trimestre_actual,
meg.eventos_grupo3_tipo3_trimestre_actual,
meg.eventos_grupo3_tipo4_trimestre_actual,
meg.eventos_grupo3_tipo6_trimestre_actual,
meg.eventos_grupo3_tipo7_trimestre_actual,
meg.eventos_grupo3_tipo8_trimestre_actual,
meg.eventos_grupo3_tipo9_trimestre_actual,
meg.eventos_grupo3_tipo10_trimestre_actual,
meg.eventos_grupo3_tipo11_trimestre_actual,
meg.eventos_grupo3_tipo12_trimestre_actual,
meg.eventos_grupo3_tipo14_trimestre_actual,
meg.eventos_grupo3_tipo15_trimestre_actual,
meg.eventos_grupo3_tipo16_trimestre_actual,
meg.eventos_grupo3_tipo17_trimestre_actual,
meg.eventos_grupo3_tipo18_trimestre_actual,
meg.eventos_grupo3_tipo19_trimestre_actual,
meg.eventos_grupo3_tipo20_trimestre_actual,
meg.eventos_grupo3_tipo21_trimestre_actual,
meg.eventos_grupo3_tipo22_trimestre_actual,
meg.eventos_grupo3_tipo23_trimestre_actual,
meg.eventos_grupo3_tipo24_trimestre_actual,
--   
 --  Trimestre pasado
meg.eventos_grupo3_tipo2_trimestre_pasado,
meg.eventos_grupo3_tipo3_trimestre_pasado,
meg.eventos_grupo3_tipo4_trimestre_pasado,
meg.eventos_grupo3_tipo6_trimestre_pasado,
meg.eventos_grupo3_tipo7_trimestre_pasado,
meg.eventos_grupo3_tipo8_trimestre_pasado,
meg.eventos_grupo3_tipo9_trimestre_pasado,
meg.eventos_grupo3_tipo10_trimestre_pasado,
meg.eventos_grupo3_tipo11_trimestre_pasado,
meg.eventos_grupo3_tipo12_trimestre_pasado,
meg.eventos_grupo3_tipo14_trimestre_pasado,
meg.eventos_grupo3_tipo15_trimestre_pasado,
meg.eventos_grupo3_tipo16_trimestre_pasado,
meg.eventos_grupo3_tipo17_trimestre_pasado,
meg.eventos_grupo3_tipo18_trimestre_pasado,
meg.eventos_grupo3_tipo19_trimestre_pasado,
meg.eventos_grupo3_tipo20_trimestre_pasado,
meg.eventos_grupo3_tipo21_trimestre_pasado,
meg.eventos_grupo3_tipo22_trimestre_pasado,
meg.eventos_grupo3_tipo23_trimestre_pasado,
meg.eventos_grupo3_tipo24_trimestre_pasado,

--  Trimestre año pasado
meg.eventos_grupo3_tipo2_trimestre_anio_pasado,
meg.eventos_grupo3_tipo3_trimestre_anio_pasado,
meg.eventos_grupo3_tipo4_trimestre_anio_pasado,
meg.eventos_grupo3_tipo6_trimestre_anio_pasado,
meg.eventos_grupo3_tipo7_trimestre_anio_pasado,
meg.eventos_grupo3_tipo8_trimestre_anio_pasado,
meg.eventos_grupo3_tipo9_trimestre_anio_pasado,
meg.eventos_grupo3_tipo10_trimestre_anio_pasado,
meg.eventos_grupo3_tipo11_trimestre_anio_pasado,
meg.eventos_grupo3_tipo12_trimestre_anio_pasado,
meg.eventos_grupo3_tipo14_trimestre_anio_pasado,
meg.eventos_grupo3_tipo15_trimestre_anio_pasado,
meg.eventos_grupo3_tipo16_trimestre_anio_pasado,
meg.eventos_grupo3_tipo17_trimestre_anio_pasado,
meg.eventos_grupo3_tipo18_trimestre_anio_pasado,
meg.eventos_grupo3_tipo19_trimestre_anio_pasado,
meg.eventos_grupo3_tipo20_trimestre_anio_pasado,
meg.eventos_grupo3_tipo21_trimestre_anio_pasado,
meg.eventos_grupo3_tipo22_trimestre_anio_pasado,
meg.eventos_grupo3_tipo23_trimestre_anio_pasado,
meg.eventos_grupo3_tipo24_trimestre_anio_pasado,

 --  Año actual
meg.eventos_grupo3_tipo2_anio_actual,
meg.eventos_grupo3_tipo3_anio_actual,
meg.eventos_grupo3_tipo4_anio_actual,
meg.eventos_grupo3_tipo6_anio_actual,
meg.eventos_grupo3_tipo7_anio_actual,
meg.eventos_grupo3_tipo8_anio_actual,
meg.eventos_grupo3_tipo9_anio_actual,
meg.eventos_grupo3_tipo10_anio_actual,
meg.eventos_grupo3_tipo11_anio_actual,
meg.eventos_grupo3_tipo12_anio_actual,
meg.eventos_grupo3_tipo14_anio_actual,
meg.eventos_grupo3_tipo15_anio_actual,
meg.eventos_grupo3_tipo16_anio_actual,
meg.eventos_grupo3_tipo17_anio_actual,
meg.eventos_grupo3_tipo18_anio_actual,
meg.eventos_grupo3_tipo19_anio_actual,
meg.eventos_grupo3_tipo20_anio_actual,
meg.eventos_grupo3_tipo21_anio_actual,
meg.eventos_grupo3_tipo22_anio_actual,
meg.eventos_grupo3_tipo23_anio_actual,
meg.eventos_grupo3_tipo24_anio_actual,
--   Año pasado
 meg.eventos_grupo3_tipo2_anio_pasado,
 meg.eventos_grupo3_tipo3_anio_pasado,
 meg.eventos_grupo3_tipo4_anio_pasado,
 meg.eventos_grupo3_tipo6_anio_pasado,
 meg.eventos_grupo3_tipo7_anio_pasado,
 meg.eventos_grupo3_tipo8_anio_pasado,
 meg.eventos_grupo3_tipo9_anio_pasado,
 meg.eventos_grupo3_tipo10_anio_pasado,
 meg.eventos_grupo3_tipo11_anio_pasado,
 meg.eventos_grupo3_tipo12_anio_pasado,
 meg.eventos_grupo3_tipo14_anio_pasado,
 meg.eventos_grupo3_tipo15_anio_pasado,
 meg.eventos_grupo3_tipo16_anio_pasado,
 meg.eventos_grupo3_tipo17_anio_pasado,
 meg.eventos_grupo3_tipo18_anio_pasado,
 meg.eventos_grupo3_tipo19_anio_pasado,
 meg.eventos_grupo3_tipo20_anio_pasado,
 meg.eventos_grupo3_tipo21_anio_pasado,
 meg.eventos_grupo3_tipo22_anio_pasado,
 meg.eventos_grupo3_tipo23_anio_pasado,
 meg.eventos_grupo3_tipo24_anio_pasado,
  ...
  CASE
    WHEN meg.tuvo_fraude_reciente = 'SI' THEN 'REINCIDENTE_RECIENTE'
    WHEN meg.tuvo_fraude_previo = 'SI' AND meg.estado_fraude = 'FRAUDE_RESUELTO' THEN 'REINCIDENTE_RESUELTO'
    WHEN meg.tuvo_fraude_previo = 'SI' AND meg.estado_fraude = 'FRAUDE_ACTIVO' THEN 'REINCIDENTE_ACTIVO'
    WHEN meg.tuvo_fraude_previo = 'SI' AND meg.estado_fraude = 'FRAUDE_PENDIENTE' THEN 'REINCIDENTE_PENDIENTE'
    ELSE 'LIMPIO'
...
LEFT JOIN metricas_eventos_grupo meg ON me.cups_sgc = meg.cups_sgc
...
ORDER BY 
  meg.tuvo_fraude_previo DESC,  -- ✅ Primero los que tienen expedientes previos
  me.cups_sgc;
