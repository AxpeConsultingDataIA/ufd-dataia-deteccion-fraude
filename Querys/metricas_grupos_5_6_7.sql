...
metricas_eventos_grupo AS (
  SELECT
    ...
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_semana_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_actual AND f.fin_semana_actual AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_semana_actual,
    
    -- Semana pasada - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_semana_pasada,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_semana_pasada AND f.fin_semana_pasada AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_semana_pasada,
    
    -- Misma semana año pasado - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_semana_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_misma_semana_anio_pasado AND f.fin_misma_semana_anio_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_semana_anio_pasado,
    
    -- Mes actual - eventos grupo 4 por tipo
    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_mes_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_actual AND f.fin_mes_actual AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_mes_actual,
    
    -- -- Mes pasado - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_mes_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mes_pasado AND f.fin_mes_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_mes_pasado,
   
    -- -- Mismo mes año pasado - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_mes_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_mes_anio_pasado AND f.fin_mismo_mes_anio_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_mes_anio_pasado,
    
    -- -- Trimestre actual - eventos grupo 4 por tipo    
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_trimestre_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_actual AND f.fin_trimestre_actual AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_trimestre_actual,
    
    -- -- Trimestre pasado - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_trimestre_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_trimestre_pasado AND f.fin_trimestre_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_trimestre_pasado,
    
    -- -- Mismo trimestre año pasado - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_trimestre_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_mismo_trimestre_anio_pasado AND f.fin_mismo_trimestre_anio_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_trimestre_anio_pasado,
    
    -- -- Año actual - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_anio_actual,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_actual AND f.fin_anio_actual AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_anio_actual,
    
    -- -- Año pasado - eventos grupo 4 por tipo
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 5 THEN 1 END) AS  eventos_grupo5_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 6 THEN 1 END) AS  eventos_grupo6_anio_pasado,
    COUNT(CASE WHEN df.fh BETWEEN f.inicio_anio_pasado AND f.fin_anio_pasado AND s09.et = 7 THEN 1 END) AS  eventos_grupo7_anio_pasado,
...
--   CASE WHEN mc.consumo_max_anio_pasado > per_aco.percentil99_anio_pasado_aco THEN true ELSE false END AS pico_anomalo_general_anio_pasado_aco,
  ...
  -- Semana actual
meg.eventos_grupo5_semana_actual,
meg.eventos_grupo6_semana_actual,
meg.eventos_grupo7_semana_actual,
  -- Semana pasada
meg.eventos_grupo5_semana_pasada,
meg.eventos_grupo6_semana_pasada,
meg.eventos_grupo7_semana_pasada,

  -- Semana año pasado
meg.eventos_grupo5_semana_anio_pasado,
meg.eventos_grupo6_semana_anio_pasado,
meg.eventos_grupo7_semana_anio_pasado,

  -- Mes actual
meg.eventos_grupo5_mes_actual,
meg.eventos_grupo6_mes_actual,
meg.eventos_grupo7_mes_actual,

  -- Mes pasado
meg.eventos_grupo5_mes_pasado,
meg.eventos_grupo6_mes_pasado,
meg.eventos_grupo7_mes_pasado,
--   
--   Mes año pasado
meg.eventos_grupo5_mes_anio_pasado,
meg.eventos_grupo6_mes_anio_pasado,
meg.eventos_grupo7_mes_anio_pasado,

--   Trimestre actual
meg.eventos_grupo5_trimestre_actual,
meg.eventos_grupo6_trimestre_actual,
meg.eventos_grupo7_trimestre_actual,

 --  Trimestre pasado
meg.eventos_grupo5_trimestre_pasado,
meg.eventos_grupo6_trimestre_pasado,
meg.eventos_grupo7_trimestre_pasado,

--  Trimestre año pasado
meg.eventos_grupo5_trimestre_anio_pasado,
meg.eventos_grupo6_trimestre_anio_pasado,
meg.eventos_grupo7_trimestre_anio_pasado,

 --  Año actual
meg.eventos_grupo5_anio_actual,
meg.eventos_grupo6_anio_actual,
meg.eventos_grupo7_anio_actual,

--   Año pasado
 meg.eventos_grupo5_anio_pasado,
 meg.eventos_grupo6_anio_pasado,
 meg.eventos_grupo7_anio_pasado,
